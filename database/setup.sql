...
-- Run this SQL file to set up your database
...
CREATE TABLE IF NOT EXISTS users (
    ...
    -- Matchmaking preferences (from questionnaire)
    ...
    style_preference VARCHAR(50), -- vintage, modern, casual, etc.
    size_preference VARCHAR(20), -- S, M, L, XL, etc.
    age_group VARCHAR(20), -- teen, adult, senior
...
CREATE TABLE IF NOT EXISTS products (
    ...
    style VARCHAR(50), -- vintage, modern, casual, formal, bohemian, minimalist, sporty, elegant
